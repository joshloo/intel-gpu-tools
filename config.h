...
#define PACKAGE_BUGREPORT "https://bugs.freedesktop.org/enter_bug.cgi?product=DRI&component=DRM/Intel"

/* Define to the full name of this package. */
#define PACKAGE_NAME "intel-gpu-tools"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "intel-gpu-tools 1.14"
